...
const TAttribAppl gattExtendedServiceTable[] =
{
	...
	/* OTA characteristic value 2 */
	{
		...
		{
			LO_WORD(GATT_UUID_CHAR_OTA),		/* bTypeValue */
			HI_WORD(GATT_UUID_CHAR_OTA),		/* bTypeValue */
		},
	    2,										/* variable size */
	    (void *)NULL,
	...
	/* OTA characteristic value 4 */
	{
		ATTRIB_FLAG_VALUE_APPL,					/* wFlags */
		{
			LO_WORD(GATT_UUID_CHAR_MAC),		/* bTypeValue */
			HI_WORD(GATT_UUID_CHAR_MAC),		/* bTypeValue */
		},
	    1,										/* variable size */
	    (void *)NULL,
	    GATT_PERM_READ							/* wPermissions */
	...
	/* OTA characteristic value 6 */
	{
		ATTRIB_FLAG_VALUE_APPL,					/* wFlags */
		{
			LO_WORD(GATT_UUID_CHAR_PATCH),		/* bTypeValue */
			HI_WORD(GATT_UUID_CHAR_PATCH),		/* bTypeValue */
		},
		1,										/* variable size */
		(void *)NULL,
		GATT_PERM_READ							/* wPermissions */
	...
	/* OTA characteristic value 8 */
	{
		ATTRIB_FLAG_VALUE_APPL,					/* wFlags */
		{
			LO_WORD(GATT_UUID_CHAR_APP_VERSION),/* bTypeValue */
			HI_WORD(GATT_UUID_CHAR_APP_VERSION),/* bTypeValue */
		},
	    1,										/* variable size */
	    (void *)NULL,
	    GATT_PERM_READ							/* wPermissions */
...
TProfileResult  OTAServiceAttrWriteCb(uint8_t ServiceId, uint16_t iAttribIndex, uint16_t wLength, uint8_t *pValue, TGATTDWriteIndPostProc *pWriteIndPostProc)
{
	...
	{
		DBG_BUFFER(MODULE_PROFILE, LEVEL_ERROR, "--> OTA_AttrWrite Error  iAttribIndex = 0x%x wLength=%d", 2, iAttribIndex, wLength);
